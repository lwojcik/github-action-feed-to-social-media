  ...
  const extraFields: Partial<FeedItem> = {
    [ExtraEntryField.enclosure]: feedEntry[ExtraEntryField.enclosure]
      ? removeUndefinedProps<Enclosure>({
          url:
            feedEntry[ExtraEntryField.enclosure][ExtraEntryProperty.url] ||
            undefined,
          type:
            feedEntry[ExtraEntryField.enclosure][ExtraEntryProperty.type] ||
            undefined,
          length:
    ...
    [ExtraEntryField.itunesSubtitle]: feedEntry[ExtraEntryField.itunesSubtitle],
    [ExtraEntryField.itunesImage]:
      feedEntry[ExtraEntryField.itunesImage]?.[ExtraEntryProperty.href],
    [ExtraEntryField.itunesExplicit]: feedEntry[ExtraEntryField.itunesExplicit],
    [ExtraEntryField.itunesKeywords]: feedEntry[ExtraEntryField.itunesKeywords],
    [ExtraEntryField.itunesEpisodeType]:
      feedEntry[ExtraEntryField.itunesEpisodeType],
    [ExtraEntryField.itunesDuration]: feedEntry[ExtraEntryField.itunesDuration],
